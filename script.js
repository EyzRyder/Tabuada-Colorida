...
resultado+="<table>";
    ...
    for(x=1;x<=num;x++){
      ...
      resultado+="<td><table style='width:110%; border: solid rgb(255, 255, 255)'>";
        ...
        for(
            ...
            if(cor >= 200 && cor <= 280 || cor >= 330){
              resultado+="<tr style='color:white;'><td style='background-color:hsl("+cor+",100%,50%)'>"+x+
            "X"+y+
            "="+total+
            "</td></tr>"
            }
            else{
              resultado+="<tr><td style='background-color:hsl("+cor+",100%,50%)'>"+x+
            "X"+y+
            "="+total+
            "</td></tr>"
            }
